...
echo -e '\033[1;91m[''\033[0m*''\033[1;91m]''\033[1;91m This Script will install PhoneNumberTracker Tool'
echo
sleep 2.0
echo -e '\033[1;91m[''\033[0m*''\033[1;91m]''\033[1;91m Please Subscribe My YT Channel = Technical Patcher'
echo
sleep 2.0
...
rm -rf PhoneNumberTracker > /dev/null 2>&1
rm -rf PhoneNumberTracker > /dev/null 2>&1
echo
sleep 2.0
echo -e '\033[1;92m[''\033[0m*''\033[1;92m]''\033[1;92m PhoneInfoga Installing...'
git clone https://github.com/NadarAthis/PhoneNumberTracker > /dev/null 2>&1 && cd PhoneNumberTracker > /dev/null 2>&1 && unzip PhoneNumberTracker > /dev/null 2>&1 && python3 -m pip install -r requirements.txt > /dev/null 2>&1 && pip2 install colorama > /dev/null 2>&1
rm -rf PhoneNumberTracker.zip > /dev/null 2>&1
rm -rf PhoneNumberTracker.sh > /dev/null 2>&1
chmod +x *
sleep 2.0
echo
echo -e '\033[1;92m[''\033[0m*''\033[1;92m]''\033[1;92m PhoneNumberTracker Successfully Installed.'
sleep 2.0
echo
